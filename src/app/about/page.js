...
const CardamomCasa = () => {
  return (
    <div className="min-h-screen bg-white lg:px-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8 lg:p-16 pb-8">
        {/* Left - Stylish Heading */}
        <div className="flex items-start">
          <h1 className="text-4xl lg:text-6xl font-serif text-emerald-800 leading-tight">
            Embracing Nature,
            <br />
            Creating Memories
            <br />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 px-8 lg:px-16 pb-8">
        ...
        <div className="space-y-4 lg:-mt-30">
